...
$(function() {    
    ...
    //sparkline("#server-load", "area", 30, 50, "basis", 750, 2000, "#fdf7eb");
		sparkline("#bitto-load", "area", 30, 50, "basis", 750, 2000, "#fdf7eb");
		sparkline("#ada-load", "area", 30, 50, "basis", 750, 2000, "#fdf7eb");
		sparkline("#iota-load", "area", 30, 50, "basis", 750, 2000, "#fdf7eb");
		sparkline("#xrp-load", "area", 30, 50, "basis", 250, 5000, "#fdf7eb");
		sparkline("#ltc-load", "area", 30, 50, "basis", 750, 2000, "#fdf7eb");
		sparkline("#xlm-load", "area", 30, 50, "basis", 350, 2000, "#fdf7eb");
